...
@Component({
  selector: 'app-bin-three',
  templateUrl: './bin-three.component.html',
  styleUrls: ['./bin-three.component.css']
})
export class BinThreeComponent implements OnInit {
  range = new FormGroup({
  ...
  sensorData(){
    this.service.getLatest3().subscribe(res=>{
  ...
  loadData(){
    ...
    if(this.range.value.start==null || this.range.value.end==null){
      ...
      this.service.getSensorDate3(dateStart,dateEnd).subscribe(res=>{
        this.sensorList=res;
  ...
  getLogs(){
    this.service.getSensorData3().subscribe(data=>{
      this.logList=data;
